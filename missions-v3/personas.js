...
window.PERSONAS = (function () {
  ...
  const personas = [
    {
      id: 'adhoc-v1',
      name: 'V1 Ad-hoc · Premio',
      level: 4,
      xp: 7200,
      xpNext: 10000,
      flow: 'adhoc-v1',
      adhocVariant: 'standard',
      blurb: 'Estado normal — 5 misiones (incluye una en curso, una completada y una vencida).',
      tagline: 'Estándar · 5 misiones',
    },
    {
      id: 'adhoc-empty',
      name: 'V1 Ad-hoc · Sin misiones',
      level: 4,
      xp: 7200,
      xpNext: 10000,
      flow: 'adhoc-v1',
      adhocVariant: 'empty',
      blurb: 'Empty state — usuario sin misiones disponibles ahora. Probamos el rebote a Recompensas.',
      tagline: 'Empty state · 0 misiones',
    },
    {
      id: 'adhoc-dense',
      name: 'V1 Ad-hoc · Catálogo amplio',
      level: 4,
      xp: 7200,
      xpNext: 10000,
      flow: 'adhoc-v1',
      adhocVariant: 'dense',
      blurb: 'P3 — 9 misiones con chips de filtro, anillo de progreso en in-progress, sin call-to-fill (denso).',
      tagline: 'Denso · filtros + progreso',
    },
    {
      id: 'new',
      name: 'Usuario nuevo',
